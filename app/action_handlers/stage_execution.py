...
def execute_stage_command(
    *,
    ...
    if route_preset_key is not None and route_preset_key.strip() and needs_model_provider:
        routed_profile_id = ProviderProfileService(session).resolve_route_stage_default_profile_id(
            preset_key=route_preset_key,
